...
const (
	FileService_SaveFile_FullMethodName     = "/gofiles.FileService/SaveFile"
	FileService_GetPublicURL_FullMethodName = "/gofiles.FileService/GetPublicURL"
)
...
func (c *fileServiceClient) GetPublicURL(ctx context.Context, in *GetPublicURLRequest, opts ...grpc.CallOption) (*GetPublicURLResponse, error) {
	out := new(GetPublicURLResponse)
	err := c.cc.Invoke(ctx, FileService_GetPublicURL_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFileServiceServer) GetPublicURL(context.Context, *GetPublicURLRequest) (*GetPublicURLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPublicURL not implemented")
}
...
func _FileService_GetPublicURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPublicURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FileServiceServer).GetPublicURL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileService_GetPublicURL_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).GetPublicURL(ctx, req.(*GetPublicURLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gofiles.FileService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FileService_GetPublicURL_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "go-files_service.proto",
}
